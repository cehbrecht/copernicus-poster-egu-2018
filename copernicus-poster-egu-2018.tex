...
%%% Logo %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  {
    \begin{minipage}{30em}
      ...
      \includegraphics[width=10em]{copernicus-logo}
      \includegraphics[width=12em]{c3s-logo}
      \includegraphics[width=7em]{qrcode-44128961}
    \end{minipage}
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{minipage}{0.6\textwidth}
    ...
    \begin{itemize}\compresslist
      ...
      \item {\bf Access control} (X509 Certificate and OAuth token) for WPS service
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \includegraphics[width=0.7\linewidth]{cp4cds-toolbox}
    ...
    \begin{itemize}\compresslist
      ...
      \item {\bf Ansible} - Ansible and Buildout is used to setup a WPS (PyWPS) % with all services
